                                ...
                                <div class="col-md-4">
                                    <article class="blog-news-single">
                                        <div class="blog-news-img">
                                            <a href="{{ route('product.single', ['slug' => $product->slug]) }}"><img style="object-fit: cover;" src="{{ asset($product->picture) }}" alt="image"></a>
                                        </div>
                                        ...
                                        <div class="blog-news-details">
                                            ...
                                            <a class="blog-more-btn" href="{{ route('product.single', ['slug' => $product->slug]) }}">{{ trans('customlang.read_more') }} <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </article>
                                </div>
                            @endforeach
